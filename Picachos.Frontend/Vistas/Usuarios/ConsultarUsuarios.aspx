...
<asp:Content ID="contConsUsua" ContentPlaceHolderID="contPHConsUsua" runat="server">
      ...
      <link rel="stylesheet" href="../../Estilos/ConsultarUsuarios.css" type="text/css"/>

      <section id="sectImg">          
           <asp:Image ID="ImgFondo"  ImageUrl="~/Imagenes/Usuarios-Consultar.png" CssClass="imgFondo" runat="server" /> 
      </section>

...
<asp:Content ID="contRegCli" ContentPlaceHolderID="contPHRegC" runat="server">
     ...
     <section class="sectContenedor">       
         ...
         <asp:TextBox  ID="txbRFC" CssClass="txbRFC" runat="server" MaxLength="60" ToolTip="Ingresar los 13 digitos del R.F.C."></asp:TextBox>
         ...
         <asp:Label ID="labDireccion" CssClass="labDireccion" runat="server" Text="Dierección:"></asp:Label>                
         <asp:TextBox  ID="TextDireccion" CssClass="TextDireccion" runat="server" MaxLength="60" ToolTip="Ingresar direccion donde se enviara el pedido"></asp:TextBox>
         ...
         <asp:TextBox  ID="txbTelefono" CssClass="txbTelefono" runat="server" MaxLength="120" ToolTip="Ingresar telefono"></asp:TextBox>
